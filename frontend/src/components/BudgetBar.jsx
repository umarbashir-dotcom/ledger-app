...
const BudgetBar = ({budget}) => {
    ...
    return (
        <div>
            ...
            { isOverBudget && (<p className="text-[11px] text-[#B54834] mt-1 font-medium">{getOverBudgetLabel(budget.amount, budget.limit)}</p>)}
        </div>
    )
}
